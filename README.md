...
7. [x] Добавлены артефакты тестирования (скриншот и видео)

## :four_leaf_clover: Список проведенных тестов:
- [x] Автотест на проверку соответствия текстов на стартовой странице сайта
- [x] Автотест на проверку соответствия текстов на странице "Контакты"
- [x] Автотест на проверку соответствия текстов на странице "О компании"
- [x] Автотест на заполнение формы "Контакты"
- [x] Запрос в строку поиска "Вакансии"
